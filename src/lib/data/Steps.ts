...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    en: {
      ...
      guessQuestion: "What percentage of the world population lives in extreme poverty?",
      explanation:
    ...
    es: {
      ...
      guessQuestion: "¿Qué porcentaje de la población mundial vive en pobreza extrema?",
      explanation:
        "Afecta a 1 de cada 10 personas (826 millones). Erradicarla para 2030 es un objetivo muy improbable",
      source:
        "Informe sobre los Objetivos de Desarrollo Sostenible 2026 | Naciones Unidas",
    },
  },
  {
    id: "step_4",
  ...
  },
  {
    ...
    en: {
      ...
      guessQuestion: "What percentage of the world population has access to electricity?",
      explanation:
    ...
    es: {
      ...
      source:
        "Informe de Progreso Energético 2026 | AIE, IRENA, DEES, Banco Mundial y OMS",
    },
  },
  {
    id: "step_6",
    ...
    en: {
      ...
      guessQuestion: "What percentage of the Earth's land is covered by permanent ice?",
      explanation:
  ...
  },
  {
    ...
    es: {
      ...
      explanation: "1 de cada 5 adultos en el mundo mantiene una adicción al tabaco",
      source:
        "Informe mundial sobre tendencias en la prevalencia del tabaquismo 2000-2024 | OMS",
    },
  },
  {
    id: "step_9",
  ...
  },
  {
    ...
    en: {
      ...
      guessQuestion: "What percentage of the global population owns 75% of total wealth?",
      explanation:
  ...
  },
  {
    ...
    en: {
      ...
      explanation: "Nearly 1 in 4 people worldwide do not identify with any religion",
      source:
    ...
    es: {
      ...
      source:
        "Cómo ha cambiado el panorama religioso mundial entre 2010 y 2020 | Pew Research Center",
    },
  },
  {
    id: "step_14",
    ...
    en: {
      ...
      guessQuestion: "What percentage of children worldwide are engaged in child labour?",
      explanation:
  ...
  },
  {
    ...
    en: {
      ...
      guessQuestion: "What percentage of the global adult population can read and write?",
      explanation:
  ...
  },
  {
    ...
    es: {
      ...
      source:
        "Estimaciones de prevalencia de la violencia contra la mujer 2023 | OMS y Naciones Unidas",
    },
  },
  {
    id: "step_19",
