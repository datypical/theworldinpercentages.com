...
export const translations = {
  en: {
    ...
    methodology: {
      ...
      seoDescription: "Detailed information about the metrics, sources, and changes",
      ...
      modal: {
        ...
        questionPlaceholder: "e.g. Percentage of world population that is left-handed?",
  ...
  es: {
    ...
    methodology: {
      ...
      seoDescription: "Información detallada sobre las métricas, fuentes y cambios.",
      title: "Sobre los datos",
      lastUpdate: "Última actualización",
      subtitle: "Documentación de fuentes, actualizaciones y criterios de selección",
