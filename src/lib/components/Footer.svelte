...
<footer class="cta-footer" id="contribute">
  <div class="cta-content">
    ...
    <p>
      {i18n.t.end.message || "This visualization is constantly updated with new metrics."}
    </p>
      ...
      >
        ...
        {#if isSuccess}
          <div class="success-message">
            ...
            <h3>
              {i18n.t.end.modal?.confirmation || "Thank you for your contribution!"}
            </h3>
            <p>
              {i18n.t.end.modal?.closingMessage ||
                "Your suggestion has been successfully saved and will be reviewed for future updates."}
            </p>
            <button type="button" class="btn-primary success-btn" onclick={closeModal}>
        ...
        {:else}
          <div class="suggest-form">
            <div class="form-group">
              <label for="question">{i18n.t.end.modal?.questionLabel || "Question"}</label
              >
              <input
                type="text"
                id="question"
            ...
            <div class="form-group">
              <label for="percentage"
                >{i18n.t.end.modal?.percentageLabel || "Percentage"}</label
              >
              <input
                type="number"
                id="percentage"
            ...
            <div class="modal-actions">
              <p class="github-promo">
                {i18n.t.end.modal?.githubPrompt || "Want to help maintain the code? "}
                <a
                  href="https://github.com/datypical/theworldinpercentages.com"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {i18n.t.end.modal?.githubLink || "Check out our GitHub"}
                </a>
              </p>
